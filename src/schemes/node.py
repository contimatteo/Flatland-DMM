...
class Node:
    ...
    def get_attribute_list(self, attr_list=[]):
        ...
        print([self.__dict__.get(attr, None) for attr in attr_list])
    ...
    def get_subtree_array(self, attr_list=[]):
        ...
        while True:
            for n in last:
                child_list = [child for child in n.get_childs() if child]  # get_childs() returns forward and turn child even if they are None
