...
class Agent(object):
    ...
    def fit(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
        ...
        callbacks._set_env(env)  # TO CHECK
        params = {
            'nb_steps': nb_steps,
        }
        ...
        observation_dict = None  # observation = None
        episode_reward_dict = None
        episode_step = None
        did_abort = False
        try:
            while self.step < nb_steps:
                if observation_dict is None:  # start of a new episode
                    ...
                    if self.processor is not None:
                        observation_dict = self.processor.process_observation(
                            observation_dict)
